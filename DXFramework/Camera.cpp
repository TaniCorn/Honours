...
void Camera::moveBackward()
{
	...
	speed = frameTime * 5.f * camSpeed;// *0.5f;
...
{
	// Update the rotation.
	rotation.y += (float)x * lookSpeed * frameTime * 250.0f;// m_speed * x;

	rotation.x += (float)y * lookSpeed * frameTime * 250.0f;// m_speed * y;
}
